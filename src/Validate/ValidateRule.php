...
namespace Woox\WebmanValidate\Validate;

/**
 * Class ValidateRule
 * @package Woox\WebmanValidate\Validate
...
class ValidateRule
{
     ...
     * @return $this
     */
    protected function addItem(string $name, mixed $rule = null, string $msg = ''): ValidateRule
    {
        if ($rule || 0 === $rule) {
            $this->rule[$name] = $rule;
        } else {
